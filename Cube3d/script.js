...
function rotate(origin, vector, angle) {
  ...
  let m11 =
    rotMatrix[0] * origin[0] +
    rotMatrix[1] * origin[3] +
    rotMatrix[2] * origin[6];
  let m12 =
    rotMatrix[0] * origin[1] +
    rotMatrix[1] * origin[4] +
    rotMatrix[2] * origin[7];
  let m13 =
    rotMatrix[0] * origin[2] +
    rotMatrix[1] * origin[5] +
    rotMatrix[2] * origin[8];
  let m21 =
    rotMatrix[3] * origin[0] +
    rotMatrix[4] * origin[3] +
    rotMatrix[5] * origin[6];
  let m22 =
    rotMatrix[3] * origin[1] +
    rotMatrix[4] * origin[4] +
    rotMatrix[5] * origin[7];
  let m23 =
    rotMatrix[3] * origin[2] +
    rotMatrix[4] * origin[5] +
    rotMatrix[5] * origin[8];
  let m31 =
    rotMatrix[6] * origin[0] +
    rotMatrix[7] * origin[3] +
    rotMatrix[8] * origin[6];
  let m32 =
    rotMatrix[6] * origin[1] +
    rotMatrix[7] * origin[4] +
    rotMatrix[8] * origin[7];
  let m33 =
    rotMatrix[6] * origin[2] +
    rotMatrix[7] * origin[5] +
    rotMatrix[8] * origin[8];
...
class cubeInterface {
  ...
  updateTransform() {
    this.DomElement.style.transform = array2DOMtransform();
  }

  array2DOMtransform() {
    return `matrix3d(${this.origin[0]}, ${this.origin[3]}, ${this.origin[6]}, 0, ${this.origin[1]}, ${this.origin[4]}, ${this.origin[7]}, 0, ${this.origin[2]}, ${this.origin[5]}, ${this.origin[8]}, 0, 0, 0, 0, 1)`;
  }
}
